...
fig4 <- (fig4a +xlim(0,NA)+ylim(0,80)) + # +ggtitle('Evaluate starting at 50, every 50th') ) + 
  (fig4b+xlim(0,NA)+ylim(0,80) )+ #+ggtitle('Evaluate starting at 50, every 10th') ) + 
  (fig4c+xlim(0,NA)+ylim(0,80)) + #+ggtitle('Evaluate starting at 20, every 10th') ) +  
  plot_layout(ncol=3)+
   plot_annotation(tag_levels = 'A')
