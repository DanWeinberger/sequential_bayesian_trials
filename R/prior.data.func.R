prior.data.func <- function( ve.obs.mean=39.4, ve.obs.lcl=5.3, ve.obs.ucl=61.2){ #mean and 95% CI (note the 97.5% CI was used for evaluationpurposes due to spending rule)
  ...
  out.list=list('ve.obs.mean'=ve.obs.mean,'log_irr.obs'=log_irr.obs,'prec.log.irr.obs'=prec.log.irr.obs)
  return(out.list)
}
