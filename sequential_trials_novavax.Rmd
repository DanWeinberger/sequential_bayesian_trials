...
seq.results3 <-threshold_application( set.eval.point=seq(1200,2000, by=100))
...
seq.results <-threshold_application( set.eval.point=seq(1000,2000, by=100))
