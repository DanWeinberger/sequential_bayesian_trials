...
```{r}
probs %>%
  filter(ve.new.trial==44.4 & Pooling_type != 'Full' & repN %in% c(1:500)) %>%
...
seq.results1 <-threshold_application( set.eval.point=c(10,20,30,40,50,100,150))
...
every 50, starting at 50 events
```{r}

seq.results2 <-threshold_application( set.eval.point=c(50,100,150))
