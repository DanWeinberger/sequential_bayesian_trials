...
#the p_xx are replicated for each 
probs <- all.mods %>% 
  group_by(repN, pop, ve.new.trial,Pooling_type) %>%
  summarize(p_any_benefit0=mean(p_any_benefit0), 
            p_nontrivial_0_95=mean(p_nontrivial_0_95), 
          p_moderate_0_75= mean(p_moderate_0_75), p_harm_o1=mean(p_harm_o1),
           p_similar_0_8__1_25=mean(p_similar_0_8__1_25)) %>%
  ungroup()
```
