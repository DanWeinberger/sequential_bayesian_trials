...
p1.cum <- seq.results1$p2 +xlim(10, 150) +ylab('Proportion of trials that have stopped')

p1.cum
ggplotly(p1.cum)
p1.hist <-seq.results1$p3
...
every 20, starting at 50 events
```{r, fig.width=5, fig.height=3}

seq.results2 <-threshold_application( set.eval.points=seq(50,150, by=20))

seq.results2$p1

seq.results2$p2+xlim(10, 150) +ylab('Proportion of trials that have stopped')



seq.results2$min.tresholds

p2.hist <-seq.results2$p3


tab2 <- seq.results2$min.tresholds %>%
  mutate(startpop=50, endpop=150, freq_look=20) 
...
p3.cum <- seq.results3$p2 +xlim(10, 150) +ylab('Proportion of trials that have stopped')
...
Every 10th, starting at 70
```{r, fig.width=5, fig.height=3}

seq.results4 <-threshold_application( set.eval.points=seq(70,150, by=10))

seq.results4$p1

seq.results4$p2

p4.hist <-seq.results4$p3


seq.results4$min.tresholds

tab4 <- seq.results4$min.tresholds %>%
  mutate(startpop=70, endpop=150, freq_look=10) 
...
p5.cum <- seq.results5$p2 +xlim(10, 150) +ylab('Proportion of trials that have stopped')

p5.cum
ggplotly(p5.cum)


p5.hist <- seq.results5$p3
p5.hist
...
(p1.cum +ggtitle('Evaluations starting at 50, every 50th')) / 
  (p3.cum+ggtitle('Evaluations starting at 50, every 10th') )/
  (p5.cum+ggtitle('Evaluations starting at 20, every 10th') )
```

Figure 5

```{r, fig.width=5, fig.height=4}
(p1.hist +xlim(0,NA)+ylim(0,80) +ggtitle('Evaluate starting at 50, every 50th') ) + 
  (p3.hist+xlim(0,NA)+ylim(0,80) +ggtitle('Evaluate starting at 50, every 10th') ) + 
  (p5.hist+xlim(0,NA)+ylim(0,80) +ggtitle('Evaluate starting at 20, every 10th') ) +  
  plot_layout(ncol=2)
```
