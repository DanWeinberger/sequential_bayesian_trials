...
prior.data <- prior.data.func(ve.obs.mean=54.2, ve.obs.lcl=29.5, ve.obs.ucl=70.2, N_cases_orig =c(42,38), pop_orig= c(854, 1686))
```
...
N.vax.test <- c(300,450,500, 550, 600,750, 900, 1000,1500)
...
```{r, fig.width=8, fig.height=3}
caterplot.func(all.mods, mod.version='mod1b',samp_size_selecter=2,parm.select='beta1') +
caterplot.func(all.mods, mod.version='mod2b',samp_size_selecter=2,parm.select='beta1')+
caterplot.func(all.mods, mod.version='mod3b',samp_size_selecter=2,parm.select='beta1')

```

```{r, fig.width=8, fig.height=3}
caterplot.func(all.mods, mod.version='mod1b',samp_size_selecter=3,parm.select='beta1') +
caterplot.func(all.mods, mod.version='mod2b',samp_size_selecter=3,parm.select='beta1')+
caterplot.func(all.mods, mod.version='mod3b',samp_size_selecter=3,parm.select='beta1')

```

```{r, fig.width=8, fig.height=3}
caterplot.func(all.mods, mod.version='mod1b',samp_size_selecter=4,parm.select='beta1') +
caterplot.func(all.mods, mod.version='mod2b',samp_size_selecter=4,parm.select='beta1')+
caterplot.func(all.mods, mod.version='mod3b',samp_size_selecter=4,parm.select='beta1')

```

```{r, fig.width=8, fig.height=3}
caterplot.func(all.mods, mod.version='mod1b',samp_size_selecter=5,parm.select='beta1') +
caterplot.func(all.mods, mod.version='mod2b',samp_size_selecter=5,parm.select='beta1')+
caterplot.func(all.mods, mod.version='mod3b',samp_size_selecter=5,parm.select='beta1')

```

```{r, fig.width=8, fig.height=3}
caterplot.func(all.mods, mod.version='mod1b',samp_size_selecter=6,parm.select='beta1') +
caterplot.func(all.mods, mod.version='mod2b',samp_size_selecter=6,parm.select='beta1')+
caterplot.func(all.mods, mod.version='mod3b',samp_size_selecter=6,parm.select='beta1')

```


```{r, fig.width=8, fig.height=3}
caterplot.func(all.mods, mod.version='mod1b',samp_size_selecter=7,parm.select='beta1') +
caterplot.func(all.mods, mod.version='mod2b',samp_size_selecter=7,parm.select='beta1')+
caterplot.func(all.mods, mod.version='mod3b',samp_size_selecter=7,parm.select='beta1')

```


```{r, fig.width=8, fig.height=3}
caterplot.func(all.mods, mod.version='mod1b',samp_size_selecter=8,parm.select='beta1') +
caterplot.func(all.mods, mod.version='mod2b',samp_size_selecter=8,parm.select='beta1')+
caterplot.func(all.mods, mod.version='mod3b',samp_size_selecter=8,parm.select='beta1')
...
```{r, fig.width=6, fig.height=3}
caterplot.func(all.mods, mod.version='mod1a',samp_size_selecter=2,parm.select='beta1') +
caterplot.func(all.mods, mod.version='mod2a',samp_size_selecter=2,parm.select='beta1')+
caterplot.func(all.mods, mod.version='mod3a',samp_size_selecter=2,parm.select='beta1')

```

or for a medium dataset
```{r, fig.width=6, fig.height=3}
caterplot.func(all.mods, mod.version='mod1a',samp_size_selecter=3,parm.select='beta1') +
caterplot.func(all.mods, mod.version='mod2a',samp_size_selecter=3,parm.select='beta1')+
caterplot.func(all.mods, mod.version='mod3a',samp_size_selecter=3,parm.select='beta1')

```

or for a medium dataset
```{r, fig.width=6, fig.height=3}
caterplot.func(all.mods, mod.version='mod1a',samp_size_selecter=4,parm.select='beta1') +
caterplot.func(all.mods, mod.version='mod2a',samp_size_selecter=4,parm.select='beta1')+
caterplot.func(all.mods, mod.version='mod3a',samp_size_selecter=4,parm.select='beta1')
...
```{r, fig.width=8, fig.height=3}
caterplot.func(all.mods, mod.version='mod1a',samp_size_selecter=1,parm.select='tau2') +

caterplot.func(all.mods, mod.version='mod2a',samp_size_selecter=1,parm.select='tau2') +
  caterplot.func(all.mods, mod.version='mod3a',samp_size_selecter=1,parm.select='tau2') +

    caterplot.func(all.mods, mod.version='mod3a',samp_size_selecter=11,parm.select='tau2') 
