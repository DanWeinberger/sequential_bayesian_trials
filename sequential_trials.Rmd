...
```{r}
prior.data <- prior.data.func(ve.obs.mean=39.4, ve.obs.lcl=5.3, ve.obs.ucl=61.2, N_cases_orig =c(350,410), pop_orig= c(14300, 27650))
...
N.vax.test <- c(300,450, 600,750, 900, 1000,1500, 2000, 2500, 3000, 3500, 5000, 7500, 10000,15000, 20000)
...
3:Gamma, 4:Half-Cauchy 5: mixture model
...
caterplot.func(all.mods, mod.version='mod5a',samp_size_selecter=1,parm.select='beta1') 
...
caterplot.func(all.mods, mod.version='mod3a',samp_size_selecter=5,parm.select='beta1')+
  caterplot.func(all.mods, mod.version='mod4a',samp_size_selecter=5,parm.select='beta1')+
  caterplot.func(all.mods, mod.version='mod5a',samp_size_selecter=5,parm.select='beta1')

```

## Alpha 
```{r, fig.width=3, fig.height=3}
caterplot.func(all.mods, mod.version='mod5a',samp_size_selecter=1,parm.select='alpha') +
  caterplot.func(all.mods, mod.version='mod5a',samp_size_selecter=11,parm.select='alpha') 
