...
source('./R/jags_modified_pois_TEST2.R') #NOTE, this is experimental version
...
caterplot.func(all.mods, mod.version='mod3a',samp_size_selecter=1,parm.select='alpha[1]') +
  caterplot.func(all.mods, mod.version='mod3a',samp_size_selecter=11,parm.select='alpha[1]') 
```
